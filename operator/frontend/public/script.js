...
async function verifyAuditReport() {
  ...
  try {
      const response = await fetch('http://localhost:3000/api/verifyAuditReport', {
          method: 'POST',
          headers: {
...
async function verifyInsurance() {
  ...
  try {
      const response = await fetch('http://localhost:3000/api/verifyInsurance', {
          method: 'POST',
          headers: {
              'Content-Type': 'application/json',
          },
...
async function verifyClaim() {
  ...
  try {
      const response = await fetch('http://localhost:3000/api/verifyClaim', {
          method: 'POST',
          headers: {
              'Content-Type': 'application/json',
          },
